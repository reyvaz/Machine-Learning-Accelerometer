...
Now I will use the 2 best performing algorithms to predict how well individuals perform the dumbbell exercises using the test dataset for submission. 
